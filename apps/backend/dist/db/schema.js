...
exports.menuItemsRelations = exports.orderItemsRelations = exports.ordersRelations = exports.tenantsRelations = exports.aiConversations = exports.reviews = exports.orderItems = exports.orders = exports.tables = exports.menuItems = exports.categories = exports.users = exports.tenants = exports.menuItemStatusEnum = exports.planEnum = exports.orderStatusEnum = exports.userRoleEnum = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const drizzle_orm_1 = require("drizzle-orm");
// ─── Enums ───────────────────────────────────────────────
exports.userRoleEnum = (0, pg_core_1.pgEnum)('user_role', [
    'super_admin', 'owner', 'manager', 'waiter', 'chef'
]);
...
exports.orders = (0, pg_core_1.pgTable)('orders', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(() => exports.tenants.id, { onDelete: 'cascade' }).notNull(),
    tableId: (0, pg_core_1.uuid)('table_id').references(() => exports.tables.id, { onDelete: 'set null' }),
...
exports.menuItemsRelations = (0, drizzle_orm_1.relations)(exports.menuItems, ({ one, many }) => ({
    ...
    category: one(exports.categories, { fields: [exports.menuItems.categoryId], references: [exports.categories.id] }),
